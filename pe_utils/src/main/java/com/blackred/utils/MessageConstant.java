...
public class MessageConstant {
    ...
    public static final String PIC_UPLOAD_SUCCESS = "图⽚上传成功";
    public static final String PIC_UPLOAD_FAIL = "图⽚上传失败";
    public static final String ADD_SETMEAL_FAIL = "新增套餐失败";
    public static final String ADD_SETMEAL_SUCCESS = "新增套餐成功";
    public static final String IMPORT_ORDERSETTING_FAIL = "批量导⼊预约设置数据失败";
    public static final String IMPORT_ORDERSETTING_SUCCESS = "批量导⼊预约设置数据成功";
    ...
    public static final String TELEPHONE_VALIDATECODE_NOTNULL = "⼿机号和验证码都不能为空";
    public static final String LOGIN_SUCCESS = "登录成功";
    public static final String VALIDATECODE_ERROR = "验证码输⼊错误";
    ...
    public static final String SELECTED_DATE_CANNOT_ORDER = "所选⽇期不能进⾏体检预约";
    ...
    public static final String GET_USERNAME_SUCCESS = "获取当前登录⽤户名称成功";
    public static final String GET_USERNAME_FAIL = "获取当前登录⽤户名称失败";
    public static final String GET_MENU_SUCCESS = "获取当前登录⽤户菜单成功";
    public static final String GET_MENU_FAIL = "获取当前登录⽤户菜单失败";
